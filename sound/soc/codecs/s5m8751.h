 ...
 * Default values.
 */
#define S5M8751_REGISTER_DEFAULTS \
{ \
    /*0x8990,*/     /* R0  - Reset */ \
...
extern struct snd_soc_dai s5m_dai;
extern struct snd_soc_codec_device soc_codec_dev_s5m;
