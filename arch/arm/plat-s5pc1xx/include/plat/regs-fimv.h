...
#define S3C_FIMV_RESERVE3		/* [(0x044 -0x02c)/4 -1] */
#define S3C_FIMV_BITS_ENDIAN		S3C_FIMVREG(0x044)
#define S3C_FIMV_RESERVE4		/* [(0x054 -0x044)/4 - 1 ] */
...
#define S3C_FIMV_RESERVE5		/* [(0x100 -0x060)/4 -1 ] */
...
#define S3C_FIMV_RESERVE6		/* 0x120 */
...
#define S3C_FIMV_RESERVE7		/* [(0x200-0x138)/4-1] */
...
#define S3C_FIMV_RESERVE10		/* [(0x400-0x328)/4-1] */
...
#define S3C_FIMV_RESERVE11		/* [(0x500-0x410)/4-1] */
...
#define S3C_FIMV_RESERVE17		/* [(0xA00-0x90C)/4-1] */
...
#define S3C_FIMV_RESERVE18		/* [(0xC00-0xA44)/4-1] */
...
#define S3C_FIMV_RESERVE19		/* [(0xD00-0xC0C)/4-1] */
