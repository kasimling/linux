...
#define S3C_MSCTRL_INFORMAT_YCBCR420		(0 << 2)
#define S3C_MSCTRL_INFORMAT_YCBCR422		(1 << 2)
#define S3C_MSCTRL_INFORMAT_YCBCR422_1PLANE	(2 << 2)
#define S3C_MSCTRL_INFORMAT_RGB			(3 << 2)
