...
#define S3C_SYSTIMER_DIV_ONE		(0<<8)
#define S3C_SYSTIMER_DIV_TWO		(1<<8)
#define S3C_SYSTIMER_DIV_FOUR		(2<<8)
#define S3C_SYSTIMER_DIV_EIGHT		(3<<8)
#define S3C_SYSTIMER_DIV_SIXTEEN	(4<<8)

#define S3C_SYSTIMER_TARGET_HZ		1000
#define S3C_SYSTIMER_PRESCALE		5
#define S3C_SYSTIMER_PRESCALER_MASK	(255<<0)
...
#define S3C_SYSTIMER_INT_ENABLE		(1<<0)
