...
#define S3C64XX_GPKDAT			(S3C64XX_GPK_BASE + 0x04)
#define S3C64XX_GPKPUD			(S3C64XX_GPK_BASE + 0x08)
#define S3C64XX_GPKCONSLP		(S3C64XX_GPK_BASE + 0x0c)
#define S3C64XX_GPKPUDSLP		(S3C64XX_GPK_BASE + 0x10)
