...
#define S3C64XX_GPLDAT			(S3C64XX_GPL_BASE + 0x04)
#define S3C64XX_GPLPUD			(S3C64XX_GPL_BASE + 0x08)
#define S3C64XX_GPLCONSLP		(S3C64XX_GPL_BASE + 0x0c)
#define S3C64XX_GPLPUDSLP		(S3C64XX_GPL_BASE + 0x10)
