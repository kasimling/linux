...
#define S5P6440_PLL_MDIV_MASK	((1 << (25-16)) - 1)
#define S5P6440_PLL_PDIV_MASK	((1 << (13-8)) - 1)
#define S5P6440_PLL_SDIV_MASK	((1 << (2-0)) - 1)
...
#define S5P6440_EPLL_MDIV_MASK	((1 << (23-16)) - 1)
#define S5P6440_EPLL_PDIV_MASK	((1 << (13-8)) - 1)
#define S5P6440_EPLL_SDIV_MASK	((1 << (2-0)) - 1)
