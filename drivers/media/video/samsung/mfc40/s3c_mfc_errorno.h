...
typedef enum
{
	...
	MFCINST_MEMORY_MAPPING_FAIL		= -8002,
	MFCINST_MEMORY_INVAILD_ADDR		= -8003,

	MFCINST_MUTEX_CREATE_FAIL		= -8101,
	MFCINST_POWER_INIT_FAIL			= -8102,
	MFCINST_POWER_ON_OFF_FAIL		= -8102,
	MFCINST_ERR_ETC				= -9001,
} MFC_ERROR_CODE;
