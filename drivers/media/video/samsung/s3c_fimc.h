...
#define V4L2_CID_ORIGINAL		(V4L2_CID_PRIVATE_BASE + 10)
#define V4L2_CID_ARBITRARY		(V4L2_CID_PRIVATE_BASE + 11)
#define V4L2_CID_NEGATIVE 		(V4L2_CID_PRIVATE_BASE + 13)
#define V4L2_CID_ARTFREEZE		(V4L2_CID_PRIVATE_BASE + 14)
#define V4L2_CID_EMBOSSING		(V4L2_CID_PRIVATE_BASE + 15)
#define V4L2_CID_SILHOUETTE		(V4L2_CID_PRIVATE_BASE + 16)
#define V4L2_CID_ROTATE_90		(V4L2_CID_PRIVATE_BASE + 20)
#define V4L2_CID_ROTATE_180		(V4L2_CID_PRIVATE_BASE + 21)
#define V4L2_CID_ROTATE_270		(V4L2_CID_PRIVATE_BASE + 22)
#define V4L2_CID_ROTATE_BYPASS		(V4L2_CID_PRIVATE_BASE + 23)
#define	V4L2_CID_ZOOMIN			(V4L2_CID_PRIVATE_BASE + 31)
#define V4L2_CID_ZOOMOUT		(V4L2_CID_PRIVATE_BASE + 32)
...
extern int s3c_fimc_reset_camera(void __iomem *regs, enum s3c_fimc_cam_slot_t ch, enum s3c_fimc_cam_reset_t type, int delay);
