/* linux/drivers/media/video/samsung/cmm/s3c-cmm.c
 *
...
#define CODEC_MEM_START			(UINT32)s3c_get_media_memory(S3C_MDEV_CMM)
...
MODULE_DESCRIPTION("S3C CMM Device Driver");
MODULE_LICENSE("GPL");
